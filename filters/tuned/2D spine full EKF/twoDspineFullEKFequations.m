...
clc
syms placeHolder th1 dth1 ddth1 th2 dth2 ddth2 th3 dth3 ddth3 th4 dth4 ddth4 Tp1 Tp2
syms signdth3 signdth4
...
dp1=1/2*Cd1*rho*A1*(dth3)^2*l3^2*signdth3;
dp2=1/2*Cd2*rho*A2*(dth4)^2*signdth4*l4^2;
...
disp('the F matrix');
states=[Tp1 Tp2 dth1 dth2 dth3 dth4 th1 th2 th3 th4];
Fequations=[DTp1,DTp2,Dwp1,Dwp2,Dwp3,Dwp4,dth1,dth2,dth3,dth4];
...
save('EKFmatrices/FfullEKF','F');
save('EKFmatrices/predictfullEKF','predict');

...
x=[(storedStates(startTime:end,7)-camAngles(startTime:end,1));(storedStates(startTime:end,8)-camAngles(startTime:end,2));(storedStates(startTime:end,9)-camAngles(startTime:end,3));(storedStates(startTime:end,10)-camAngles(startTime:end,4))];

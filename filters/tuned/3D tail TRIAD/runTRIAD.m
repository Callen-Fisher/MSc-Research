...
clear A1 A2 Bx By Bz Cd1 Cd2 DimValues E Gx Gy Gz I J1 J2 Ke L R R1wrt0 Rx Ry Rz  acc3 acc4 calAccS1 calAccS2 calAccS3 calAccS4 calMagS1 calMagS2 calMagS3
...
[costFunction,costFunctionPosition,storedStates,storedPositions]=TRIAD(g1,g2,a1,a2,ma1,ma2,magVecX,magVecY,magVecZ,g,Q,I,covP,val1,val2,val3,val4,sampleTime,camAngles,camData,l1,l2,states,val5,val6,val7,val8);

camAngles(20:end,1)=camAngles(20:end,1)-0.2;
camAngles(20:end,3)=camAngles(20:end,3)-0.2;


clear z updateEq states startTime sampleTime sampleLength predictEq initTh1 initTh2 initPh1 initPh2 i  covP TorqueMotor R Q K I Hmatrix Fmatrix
...
xlabel('Samples','FontSize',10)
ylabel('Angle (radians)','FontSize',10)
suptitle('3D tail TRIAD KF Estimated Angles Compared to Camera System Angles')
...
subplot(2,3,2);
plot(camData.signals.values(20:end,2)','r','LineWidth',2);
hold on
plot(storedPositions(20:end,2)','b','LineWidth',2);
...
xlabel('Samples','FontSize',10)
ylabel('Position (m)','FontSize',10)
suptitle('3D tail TRIAD KF Estimated Positions Compared to Camera System Positions')
legend('Camera system data','TRIAD KF algorithm')

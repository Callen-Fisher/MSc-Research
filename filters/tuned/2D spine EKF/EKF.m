%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [costFunction,costFunctionPosition,storedStates,storedPositions]=EKF(val3,val4,val5,val6,states,I,R,a1,a2,a3,a4,sampleTime,g1,g2,g3,g4,covP,camAngles,ma1,ma2,ma3,ma4,l1,l2,l3,l4,camData)
Q=diag([val3,val4,val5,val6,0,0,0,0]);
startTime=20;
for i=startTime:1:length(a1.signals.values(:,1)) 
    predictEq=predictFunctionEKF(states(1),states(2),states(3),states(4),states(5),states(6),states(7),states(8));
   
    Fmatrix=FfunctionEKF(states(1),states(2),states(3),states(4),states(5),states(6),states(7),states(8));
    ...
    updateEq=updateFunctionEKF(predictEq(1),predictEq(2),predictEq(3),predictEq(4),states(1),states(2),states(3),states(4),states(5),states(6),states(7),states(8));
    
    Hmatrix=HfunctionEKF(predictEq(1),predictEq(2),predictEq(3),predictEq(4),states(1),states(2),states(3),states(4),states(5),states(6),states(7),states(8));

...
xlabel('Samples','FontSize',10)
ylabel('Angle (radians)','FontSize',10)
suptitle('2D tail Multibody Estimated Angles Compared to Camera System Angles')
...
xlabel('Samples','FontSize',10)
ylabel('Position (m)','FontSize',10)
suptitle('2D tail Multibody Estimated Positions Compared to Camera System Positions')
legend('Camera system data','Multibody algorithm')
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
figure(3)
subplot(2,1,1);
...
xlabel('Samples','FontSize',10)
ylabel('Angular Rate (rad/s)','FontSize',10)
suptitle('2D tail Multibody Estimated Angular Rate')
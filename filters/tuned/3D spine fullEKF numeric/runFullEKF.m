...
[costFunction,storedStates,storedPositions]=fullEKF(val1,val2,val3,val4,val5,val6,val7,val8,val9,val10,val11,val12,states,covP,R,I,sampleTime,camData,a1,a2,a3,a4,g1,g2,g3,g4,ma1,ma2,ma3,ma4,l1,l2,l3,l4);
...
suptitle('3D Spine and Tail Multibody and Torque Estimated Positions Compared to Camera System Positions')
...
title('Tau pitch 1 estimate','FontSize',12)
xlabel('Samples','FontSize',10)
ylabel('Torque (Nm)','FontSize',10) 
subplot(2,2,2);
plot(storedStates(20:end,2)','b','LineWidth',2);
title('Tau yaw 1 estimate','FontSize',12)
xlabel('Samples','FontSize',10)
ylabel('Torque (Nm)','FontSize',10) 
subplot(2,2,3);
plot(storedStates(20:end,3)','b','LineWidth',2);
title('Tau pitch 2 estimate','FontSize',12)
xlabel('Samples','FontSize',10)
ylabel('Torque (Nm)','FontSize',10) 
subplot(2,2,4);
plot(storedStates(20:end,4)','b','LineWidth',2);
title('Tau yaw 2 estimate','FontSize',12)
xlabel('Samples','FontSize',10)
ylabel('Torque (Nm)','FontSize',10) 
...
xlabel('Samples','FontSize',10)
ylabel('Angular Rate (rad/s)','FontSize',10)
suptitle('3D Spine and Tail Multibody and Torque Estimated Angular Rate')
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
subplot(4,3,8);
plot(storedStates(20:end,21)','b','LineWidth',2);
title('Theta 3','FontSize',12)
xlabel('Samples','FontSize',10)
ylabel('Angle (radians)','FontSize',10)
subplot(4,3,9);
plot(storedStates(20:end,22)','b','LineWidth',2);
title('Psi 3','FontSize',12)
xlabel('Samples','FontSize',10)
ylabel('Angle (radians)','FontSize',10)

subplot(4,3,11);
plot(storedStates(20:end,23)','b','LineWidth',2);
title('Theta 4','FontSize',12)
xlabel('Samples','FontSize',10)
ylabel('Angle (radians)','FontSize',10)
subplot(4,3,12);
plot(storedStates(20:end,24)','b','LineWidth',2);
title('Psi 4','FontSize',12)
xlabel('Samples','FontSize',10)
ylabel('Angle (radians)','FontSize',10)


suptitle('3D Spine and Tail Multibody and Torque Estimated Angles')
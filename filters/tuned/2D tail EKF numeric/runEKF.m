...
[costFunction,costFunctionPosition,storedStates,storedPositions]=EKF(val3,val4,states,I,R,a1,a2,sampleTime,g1,g2,covP,camAngles,ma1,ma2,l1,l2,camData);
...
xlabel('Samples','FontSize',10)
ylabel('Angle (radians)','FontSize',10)
suptitle('2D tail Numeric Multibody Estimated Angles Compared to Camera System Angles')
legend('Camera system data','Numeric Multibody algorithm')
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
figure(2)
subplot(2,2,1);
...
xlabel('Samples','FontSize',10)
ylabel('Position (m)','FontSize',10)
suptitle('2D tail Numeric Multibody Estimated Positions Compared to Camera System Positions')
legend('Camera system data','Numeric Multibody algorithm')
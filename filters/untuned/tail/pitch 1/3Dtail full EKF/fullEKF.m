...
x=[(storedStates(startTime:end,9)-camAngles(startTime:end,1));(storedStates(startTime:end,10)-camAngles(startTime:end,2));(storedStates(startTime:end,11)-camAngles(startTime:end,3));(storedStates(startTime:end,12)-camAngles(startTime:end,4))];
